        ...
        <van-cell-group inset class="serve">
            ...
            <van-grid class="serve-item" :border="false">
                <van-grid-item class="serve-item-list">
                    <van-image src="/src/assets/user/kaitonghuiyuan.png" class="serve-item-list-icon"
                        @click="router.push('/user/consumers')" />
                    <div class="serve-item-title">开通记录</div>
                </van-grid-item>
                <van-grid-item class="serve-item-list">
                    <van-image src="/src/assets/user/duihuan.png" class="serve-item-list-icon"
                        @click="router.push('/user/redeeming')" />
                    <div class="serve-item-title">兑换记录</div>
                </van-grid-item>
                <van-grid-item class="serve-item-list">
                    <van-image src="/src/assets/user/shouhuodizhi.png" class="serve-item-list-icon"
                        @click="router.push('/user/address')" />
                    <div class="serve-item-title">收货地址</div>
                </van-grid-item>
                <van-grid-item class="serve-item-list">
                    <van-image src="/src/assets/user/fankui.png" class="serve-item-list-icon"
